        ...
        >
          <h1 className="text-heading-1 text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 ml-2">
              <RotatingText
                texts={['AI Powered', 'Smart Automation', 'AI-Driven Efficiency', 'Next-Gen Solutions']}
                mainClassName=" px-2 sm:px-2 md:px-3 bg-gradient-to-r from-blue-600 to-violet-600-300 text-red-600 overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
                staggerFrom={"last"}
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "-120%" }}
          ...
          <Paragraph className="mt-8">
            ...
            <span
              className="
                font-semibold
                bg-gradient-to-r from-orange-700 via-blue-500 to-green-400
                text-transparent bg-clip-text
                bg-300% animate-gradient
                text-base sm:text-lg md:text-4xl
              "
            >
              Welcome to WorkNest AI,<br />where innovation meets efficiency.

              </span><br></br>
            Plug into the power of AI and watch your business evolve. From real-time insights to hands-free automation, our platform transforms the way you work—so you can move quicker, think bigger, and lead the future.
